...
def main():
    ...
    bullet(doc, "Télétravail : sur les offres renseignées de l'échantillon, {} % proposent du télétravail total ou partiel (n={}) ; Indeed compte plus de 300 offres « Développeur Web Remote » (2 sept. 2026) et plus de 100 « Télétravail Développeur Full Stack » (29 mai 2026), soit environ un dixième du stock national : le marché à distance existe mais reste minoritaire et plutôt réservé aux profils expérimentés.".format(tel_s, tel_k))
    bullet(doc, "Limite : le ratio offres pour 100 000 actifs n'a pas pu être calculé faute de données INSEE régionales lisibles dans les extraits (colonne OFFRES_POUR_100_000_ACTIFS = NC, sauf si une session complémentaire les a collectées).")
    ...
    lect = {
        "Paris et Île-de-France": "Marché le plus profond (Indeed « Développeur Web » plus de 900 offres actives à Paris au 4 septembre 2026 ; HelloWork « Développeur » plus de 1 700 en IDF en juillet 2026) et le plus exposé à l'IA : la quasi-totalité des offres AI Engineer/LLM y sont localisées ; stages et alternances abondants (Indeed « Stage Développeur Web » IDF plus de 800 en janvier 2025). Concurrence forte entre écoles ; les profils juniors doivent se différencier (industrialisation, IA appliquée).",
        "Lyon et métropole": "Deuxième bassin : Indeed « Développeur » 300 à 400 offres actives (mai-août 2026), « Développeur Web » plus de 200 (sept. 2025 et juillet 2026, stable), « Développeur Full Stack » plus de 100 ; tissu ESN + éditeurs + industrie ; peu de mentions IA dans les offres locales. Salaires affichés 35-58 k€.",
        "Lille et métropole": "Bassin dynamique (retail/e-commerce, AdTech, ESN) : full stack et Java dominants ; offres citant explicitement Copilot/Cursor (Groupe M6 AdTech) ; alternance présente. Presse régionale : demande orientée vers développeurs expérimentés et leads.",
        "Bordeaux et métropole": "Bassin de taille moyenne : PHP/Laravel/Vue, .NET/React, Angular ; plusieurs offres senior ; alternance présente (CONVO, NLFL). Aucune série de stock 2024/2025 disponible : évolution NC.",
        "Nantes et métropole": "Bassin ESN et éditeurs (Sopra Steria, Aubay, Edflex, Yuzu) ; full stack, mobile et .NET ; alternance bien représentée (WTTJ). Apec signale des tensions spécifiques informatique en Pays de la Loire.",
        "Marseille et Aix-en-Provence": "Bassin le plus petit des six : Indeed « Développeur » environ 100 offres actives (mars-août 2026), « Développeur Web » plus de 75 (sept. 2026), « Développeur Alternance » plus de 75 (avril 2026) ; full stack et web générique ; très peu de mentions IA. Le télétravail et le marché national à distance comptent davantage ici.",
        "Marché national à distance": "Offres en télétravail intégral : quasi exclusivement full stack et profils expérimentés (fourchettes 44-50 k€) ; part de mentions IA la plus élevée ; débouché réaliste seulement après une première expérience.",
    }
    for z in NEXA_CITIES:
        bullet(doc, f"{z} : {lect[z]}")
    p(doc, "Réponse à la question 12 (adaptations par campus) : socle commun identique sur les six campus, mais accent alternance et e-commerce/retail à Lille et Nantes, industrialisation et ESN à Lyon, IA appliquée et scale-ups à Paris, préparation au marché à distance et à la mobilité à Marseille-Aix et Bordeaux, où le volume local reste limité. Confiance MOYENNE (échantillon de 22 à 121 offres par ville).", bold=True)
    ...
    table(doc, ["Question", "Réponse fondée sur les résultats"], [
        ...
        ["Faut-il la repositionner vers le full stack ?", "Oui : 37 % des offres uniques de l'échantillon portent l'intitulé full stack, contre 13 % « développeur web » ; le stock Indeed full stack progresse quand celui de « développeur web » recule."],
    ...
    table(doc, ["Critère", "SCÉNARIO A — MAINTIEN", "SCÉNARIO B — TRANSFORMATION", "SCÉNARIO C — MONTÉE EN GAMME (M1/M2)"], [
        ...
        ["POTENTIEL_NATIONAL", "En recul : stock « développeur web » -25 % de palier 2025-2026, offres cadres -20 %", "Stable à croissant : full stack premier intitulé (37 % de l'échantillon), stock Indeed en hausse", "Croissant : cloud/cyber/IA en tension (BMO 49,5 % de projets difficiles, Apec +5 % activités informatiques 2026)"],
    ...
    H = [
        ...
        ["H10. Les différences territoriales justifient une stratégie distincte selon les campus NEXA.", "PARTIELLEMENT_CONFIRMEE", "Paris = 29 % des offres Apec et 37 % de l'échantillon, seule ville avec un marché IA ; Lyon 300-400 offres « développeur » actives, Marseille ≈ 100 ; Lille/Nantes alternance et e-commerce ; Apec prévisions régionales +2 à +6 %.", "collecte ; Apec régional ; BMO 2026", "Les compétences demandées sont homogènes d'une ville à l'autre : la stratégie diffère par le volume, l'alternance et les partenaires, pas par le contenu.", "MOYENNE", "Socle commun national, déclinaison locale des partenariats et du volume d'admission."],
    ]
